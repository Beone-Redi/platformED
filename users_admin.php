            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        ...
                        <p class="category">Administrator users overview.</p>
                        <p class="category">
                            </br>
                        ...
                        <table class="table table-hover table-striped" id="Users">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_users?scr=13&idu=<?php echo $data[$i+1]; ?>" rel="tooltip" title="Update" class="btn btn-default btn-sm">
                                        ...
                                        <?php 
                                            ...
                                            {
                                        ?>
                                                <a href="users_admin?scr=13&urlToken=<?php echo $urlToken; ?>&idu=<?php echo $data[$i+1]; ?>&sta=<?php echo $data[$i + 4]; ?>" rel="tooltip" title="Inactive" class="btn btn-default btn-sm">
                                        ...
                                        <?php
                                            ...
                                            {
                                        ?>
                                                <a href="users_admin?scr=13&urlToken=<?php echo $urlToken; ?>&idu=<?php echo $data[$i+1]; ?>&sta=<?php echo $data[$i + 4]; ?>" rel="tooltip" title="Active" class="btn btn-default btn-sm">
