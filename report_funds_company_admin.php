...
if ( $_SERVER[ 'REQUEST_METHOD' ] == 'POST' )
{
    ...
    if($_POST["inputEmpresa"]=='TODOS')
    {
        ...
        //echo 'entro todos';
        $dEmpresasI = $app->GetFundsAllCompany( $fecha_ini, $fecha_fin );
        $empresa='TODOS';
        if ( $dEmpresasI )
        {
            $msg    = 'Hecho!';
    ...
    {
        $dEmpresasI = $app->GetFundstoCompany( $_POST['inputEmpresa'], $fecha_ini, $fecha_fin );
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        ...
                        <p class="category">General view of the report of the funds received in the company.</p>
                        <p class="category"></p>
                        <form action="report_funds_company_admin?scr=55" method="POST" onsubmit="checkSubmit('btsubmit');">
                            <div class="row">
                                <div class="col-md-4">
