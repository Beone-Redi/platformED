...
$perfiles_disponibles=$app->getNameProfilesbyLevel(5); // NIVEL 5 ES ABAJO DE EMPRESAS
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="content">
                        <form action="create_users_profile_company?scr=14" method="POST" enctype="multipart/form-data" onsubmit="return checkSubmit('btsubmit');" />
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <label for="inputNombreCompleto">Name</label>
