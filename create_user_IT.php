...
{*/
    ...
    {        
        ...
        $ComisionAdmin=$app->GetComisionCompanyByIde($empresa);
        
        /*$ComisionA= array(2.5,16);

        if ( !empty($ComisionAdmin) )
        {
            $ComisionAdmin = $ComisionA;
        }
        else 
        {
            $ComisionAdmin;
                                        ...
                                        else
                                        {
                                            ...
                                            if($band_correo==0)
                                            {
                                                ...
                                                if(substr( $Respuesta1, 0, 2 ) <> '01') // si se creo correctamente el usuario
                                                {
                                                    ...
                                                    $Usuario=$user;
                                                    $inputCiudad;
                                                    $Data=[$IdUserAPI,$IdCard,$Month,$Anio,$Company,$Usuario,$inputCiudad,$aCompany[1]];//Idcard,mes,anio,compañia,usuario,ciudad
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="header">
                        <!-- <h4 class="title">Alta de tarjetahabiente</h4> -->
                        <h4 class="title">Cardholder registration</h4>
                        <h4 class="title">Create Users by Layout (Maximum 10 for load)</h4>
                    </div>
                    <div class="content">     
                        <form action="create_user_IT?src=9" method="POST" id="form2" enctype="multipart/form-data" onsubmit="return checkSubmitBlock('btsubmit3');">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control companias2" id="inputEmpresa" name="inputEmpresa" required >
                                            <option value=""></option>
