                ...
                <div class="row">
                    ...
                    <?php if ( strlen( $msg ) == 6 ) { ?> 
                        <div class="alert alert-success">
                            ...
                            <span><b> successfull - </b> Data updated correctly.</span>
                        </div>
                    <?php } elseif ( strlen( $msg ) == 5 ) { ?>
                        <div class="alert alert-danger">
                            <button type="button" aria-hidden="true" class="close">×</button>
                            <span><b> Error - </b> Failed to update data, try again later.</span>
                        </div>
                    <?php } ?>
                    ...
                    <div class="col-md-8">  
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="POST" action="edit_users_company?scr=14&idu=<?php echo $_GET['idu']; ?>" onsubmit="return checkSubmit('btsubmit');">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" required class="form-control" name="inputObservaciones" placeholder="" ><?php echo utf8_encode($dUsuario[6]); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    &nbsp;
                                    <a href="users_company?scr=14" class="btn btn-default btn-sm" >
                            ...
                            <div class="content">
                                <div class="author">
                                    <a href="#">
                                        ...
                                        <h4 class="title"><?php echo $dUsuario[2]; ?><br />
